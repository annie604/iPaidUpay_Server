/*
  ...
  - The primary key for the `GroupProduct` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "GroupProduct" DROP CONSTRAINT "GroupProduct_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "groupId" SET DATA TYPE TEXT,
ADD CONSTRAINT "GroupProduct_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "GroupProduct_id_seq";
